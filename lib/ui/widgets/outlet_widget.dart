...
class _OutletWidgetState extends State<OutletWidget> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => onOutletTapped(widget.outlet),
      child: Container(
        height: twoHundredDp,
                      ...
                      ? Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Text(dateFormatter(formatType: 'dd MMM yyyy | h:mm a', dateTime: widget.outlet.reminder!)),
  ...
  Future<void> onOutletTapped(Outlet outlet) async {
    await switchScreenWithConstructor(context, MessagePage(outlet: outlet));
  }
}
