...
import '../../business_logic/models/load_audio_data.dart';
...
class _WaveformsDashboardState extends State<WaveformsDashboard> {
  ...
  Future<void> playAudio() async {
    ...
    int maxDurationInmilliseconds = (await audioPlayer.fixedPlayer!.getDuration()) as int;
          ...
          children: [
              ...
              children: [
                /*       ElevatedButton(
                  style: OutlinedButton.styleFrom(
                    backgroundColor: waveformType != WaveformType.polygon ? Colors.blue : Colors.red,
                  ),
                  onPressed: () {
                    setState(() {
                      // totalSamples = 256;
                ...
                ElevatedButton(
                  style: OutlinedButton.styleFrom(
                    backgroundColor: waveformType != WaveformType.rectangle ? Colors.blue : Colors.red,
                  ),
                  onPressed: () {
                    setState(() {
                      totalSamples = 256;
                ...
                ElevatedButton(
                  style: OutlinedButton.styleFrom(
                    backgroundColor: waveformType != WaveformType.squiggly ? Colors.blue : Colors.red,
                  ),
                  onPressed: () {
                    setState(() {
                      totalSamples = 256;
                ...
                ElevatedButton(
                  style: OutlinedButton.styleFrom(
                    backgroundColor: waveformType != WaveformType.curvedPolygon ? Colors.blue : Colors.red,
                  ),
                  onPressed: () {
                    setState(() {
                      totalSamples = 256;
            ...
            Slider(
              ...
              onChanged: (val) {
                setState(() {
                  ...
                  audioPlayer.fixedPlayer!.seek(Duration(milliseconds: (maxDuration.inMilliseconds * val).toInt()));
                });
              },
            ),
            Slider(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    setState(() {
                      sliderValue = 0;
                      audioPlayer.fixedPlayer!.seek(const Duration(milliseconds: 0));
                    });
                  },
            ...
            Wrap(
              children: [
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    setState(() {
                      ...
                      waveformCustomizations.activeColor =
                          Color.fromRGBO(Random().nextInt(255), Random().nextInt(255), Random().nextInt(255), 1);
                    });
                  },
                ...
                sizedBox,
                if (waveformType == WaveformType.polygon || waveformType == WaveformType.rectangle)
                  ElevatedButton.icon(
                    onPressed: () {
                      setState(() {
                        waveformCustomizations.inactiveGradient = LinearGradient(colors: [
                          Color.fromRGBO(Random().nextInt(255), Random().nextInt(255), Random().nextInt(255), 1),
                          Color.fromRGBO(Random().nextInt(255), Random().nextInt(255), Random().nextInt(255), 1),
                        ], stops: const [
                          0.4,
                ...
                if (waveformType == WaveformType.polygon || waveformType == WaveformType.rectangle)
                  ElevatedButton.icon(
                    onPressed: () {
                      setState(() {
                        waveformCustomizations.activeGradient = LinearGradient(colors: [
                          Color.fromRGBO(Random().nextInt(255), Random().nextInt(255), Random().nextInt(255), 1),
                          Color.fromRGBO(Random().nextInt(255), Random().nextInt(255), Random().nextInt(255), 1),
                        ], stops: const [
                          0.4,
                ...
                Column(
                  children: [
                    const Text("Absolute ", style: TextStyle(color: Colors.white)),
                    Switch(
                ...
                Column(
                  children: [
                    const Text("Invert ", style: TextStyle(color: Colors.white)),
                    Switch(
                      inactiveTrackColor: Colors.grey[300],
                ...
                Column(
                  children: [
                    const Text("Hide Active Waveform", style: TextStyle(color: Colors.white)),
                    Switch(
                      inactiveTrackColor: Colors.grey[300],
            ...
            Wrap(
              ...
              children: [
                if (waveformType == WaveformType.polygon || waveformType == WaveformType.curvedPolygon)
                  Row(
                  ...
                  Wrap(
                    children: [
                      const Text("BorderWidth : ", style: TextStyle(color: Colors.white)),
                      Slider(
                      ...
                      Column(
                        children: [
                          const Text("isRounedRectangle", style: TextStyle(color: Colors.white)),
                          Switch(
                            inactiveTrackColor: Colors.grey[300],
                            value: waveformCustomizations.isRoundedRectangle,
                            onChanged: (value) {
                              setState(() {
                                waveformCustomizations.isRoundedRectangle = value;
                              });
                            },
                          ),
                        ],
                      ...
                      Column(
                        children: [
                          const Text("isCentered", style: TextStyle(color: Colors.white)),
                          Switch(
                            inactiveTrackColor: Colors.grey[300],
                  ...
                  Row(mainAxisSize: MainAxisSize.min, children: [
                    const Text("Stroke Width : ", style: TextStyle(color: Colors.white)),
                    Slider(
                        value: waveformCustomizations.borderWidth,
                        max: 10,
                        onChangeEnd: (value) {
