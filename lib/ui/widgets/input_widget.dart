...
class _InputWidgetState extends State<InputWidget> {
  ...
  Widget _searchTextField() {
    return Card(
      ...
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(sixDp)),
      child: Container(
          width: widget.width,
          margin: widget.edgeInsetsGeometry,
          child: TextFormField(
            ...
            decoration: InputDecoration(
                border:
                    const OutlineInputBorder(borderSide: BorderSide.none, borderRadius: BorderRadius.all(Radius.circular(sixDp))),
              ...
              labelStyle:
                  const TextStyle(color: ThemeColor.kAppGray, fontFamily: 'regu
                  lar'),*/
                filled: true,
                fillColor: widget.filledColor,
                //ThemeColor.kAppGray.withOpacity(.2)
                suffix: widget.suffixIcon,
                hintText: widget.hint,
                helperStyle: const TextStyle(fontSize: tenDp),
                hintStyle: const TextStyle(color: Colors.black45, fontFamily: 'regular'),
                focusedBorder: OutlineInputBorder(
                    borderSide: BorderSide(
                      color: widget.focusAndEnableColor,
                    ),
